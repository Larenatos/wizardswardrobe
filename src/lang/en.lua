local language = {
	...
	WW_MSG_DEPOSIT_PAGE = "Depositing all setups of [%s] to bank.",
	WW_MSG_DEPOSIT_ALL = "Depositing gear saved to any character to bank.",
  ...
  WW_MENU_AUTO_SELECT_GENERAL_TT = "Automatically selects the general section when entering a zone without a dedicated section.",
	...
	WW_BUTTON_BANKALL = "|cFFFFFF[Shift + Click]|r to deposit gear saved on any character",
